...
function loadBook(data, cfi, manager, flow, spread, snap, allowScriptedContent, direction, useCustomSwipe, backgroundColor, foregroundColor) {
  // Set a fixed height or use viewport units but ensure content is visible
  var viewportHeight = window.innerHeight;
  document.getElementById('viewer').style.height = viewportHeight + 'px';
  document.getElementById('viewer').style.overflow = 'auto';
